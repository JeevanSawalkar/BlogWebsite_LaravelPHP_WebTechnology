    ...
    <div class="d-flex align-items-stretch">
      ...
      <!-- Sidebar Navigation end-->
        <div class="page-content">
            ...
            <h1 class="m-4 display-4 text-left">Edit Post</h1>
            <form class="m-4" action="{{ url('update_post',$post->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                ...
                <div>
                    ...
                    <img src="/postimage/{{ $post->image }}" class="img-fluid" alt="Responsive image" 
